...
namespace PlayerManager
{
    ...
    public class Frostbolt : IEntity, IDisposable
    {
        #region Properties and fields

        protected Texture2D abilityTexture;
        protected Vector2 velocity;
        protected Vector2 direction;
        protected Vector2 movement;
        protected bool disposed;
        AnimationPlayer abilityPlayer;
        ...
        public Frostbolt(Texture2D newTexture, Rectangle playerPosition)
        {
            abilityPlayer = new AnimationPlayer();
            abilityTexture = newTexture;
            abilityRectangle = playerPosition;
            abilityAnimation = new Animation(newTexture, 32, 70f, true);
        }
